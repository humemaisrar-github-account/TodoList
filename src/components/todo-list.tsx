...
export default function TodoList() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-orange-200 dark:bg-gray-900">
      {/* Center the todo list within the screen */}
      <div className="w-full max-w-md bg-orange-100 dark:bg-gray-900 shadow-lg rounded-lg p-6">
        {/* Header with title */}
        <h1 className="text-2xl font-bold mb-4 text-orange-700 dark:text-gray-200 animate-pulse">
          Todo List
        </h1>
        ...
        <div className="flex items-center mb-4">
          <Input
            ...
            className="flex-1 mr-2 px-3 py-2 rounded-md border-orange-400 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200"
          />
          <Button
            onClick={addTask}
            className="bg-orange-600 hover:bg-orange-800 text-white font-medium py-2 px-4 rounded-md"
          >
            Add
          </Button>
        </div>
        ...
        <div className="space-y-2">
          {tasks.map((task) => (
            <div
              key={task.id}
              className="flex items-center justify-between bg-orange-300 dark:bg-gray-700 rounded-md px-4 py-2"
            >
              <div className="flex items-center">
                ...
                {editingTaskId === task.id ? (
                  ...
                  <Input
                    ...
                    className="flex-1 px-3 py-2 rounded-md border border-orange-400 :border-gray-600 dark:bg-gray-800 dark:text-gray-200"
                  />
                ) : (
                  // Display task text
                  <span
                    className={`flex-1 text-gray-800 dark:text-gray-00 ${
                      task.completed
              ...
              <div className="flex items-center">
                {editingTaskId === task.id ? (
                  ...
                  <Button
                    onClick={updateTask}
                    className="bg-orange-200 hover:bg-orange-400 text-white font-medium py-1 px-2 rounded-md mr-2"
                  >
                    Save
                  </Button>
                ) : (
                  ...
                  <Button
                    ...
                    className="bg-orange-200 hover:bg-orange-400 text-gray-800 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-gray-200 font-medium py-1 px-2 rounded-md mr-2"
                  >
                    Edit
                  </Button>
                )}
                ...
                <Button
                  ...
                  className="bg-orange-600 hover:bg-orange-800 text-white font-medium py-1 px-2 rounded-md"
                >
                  Delete
                </Button>
              </div>
